...
export const RUNTIME_FIELDS = {
  ...
  stockContributionMonthly: INPUT_DEFINITION_BY_CELL.B11.fieldId,
  statutoryRetirementAge: INPUT_DEFINITION_BY_CELL.B20.fieldId,
  annualPensionAtRetirement: INPUT_DEFINITION_BY_CELL.B22.fieldId,
  annualLivingExpenses: INPUT_DEFINITION_BY_CELL.B26.fieldId,
  lifeExpectancyAge: INPUT_DEFINITION_BY_CELL.B255.fieldId,
  spendingAdjustmentAge1: INPUT_DEFINITION_BY_CELL.B256.fieldId,
  spendingAdjustmentAge2: INPUT_DEFINITION_BY_CELL.B257.fieldId,
  spendingAdjustmentFirstBracket: INPUT_DEFINITION_BY_CELL.B258.fieldId,
  spendingAdjustmentSecondBracket: INPUT_DEFINITION_BY_CELL.B259.fieldId,
  spendingAdjustmentFinalBracket: INPUT_DEFINITION_BY_CELL.B260.fieldId,
  generalInflation: INPUT_DEFINITION_BY_CELL.B266.fieldId,
  propertyAnnualAppreciation: INPUT_DEFINITION_BY_CELL.B268.fieldId,
  cashInterestRate: INPUT_DEFINITION_BY_CELL.B270.fieldId,
  stockMarketReturn: INPUT_DEFINITION_BY_CELL.B272.fieldId,
  salaryAnnualGrowthRate: INPUT_DEFINITION_BY_CELL.B274.fieldId,
  rentalIncomeAnnualIncrease: INPUT_DEFINITION_BY_CELL.B276.fieldId,
  pensionReductionPerYearEarly: INPUT_DEFINITION_BY_CELL.B278.fieldId,
  minimumCashBuffer: INPUT_DEFINITION_BY_CELL.B280.fieldId,
  legacyAmount: INPUT_DEFINITION_BY_CELL.B282.fieldId,
  stockSellingCostRate: INPUT_DEFINITION_BY_CELL.B284.fieldId,
  propertyDisposalCostRate: INPUT_DEFINITION_BY_CELL.B286.fieldId,
  otherAssetDisposalCostRate: INPUT_DEFINITION_BY_CELL.B288.fieldId
